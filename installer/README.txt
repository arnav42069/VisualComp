...
----------------------------------------------------------------
   ...
   VisualComp 2.25 - User Manual.pdf   Complete illustrated manual
...
----------------------------------------------------------------
   ...
   2. Double-click  "Install VisualComp 2.25.bat"
   ...
   5. The plugin appears as "VisualComp 2.25" by Azazel Audio.

   To remove it later, run "Uninstall VisualComp 2.25.bat".
   Your presets are never touched by the uninstaller.

   Prefer to install by hand? Copy the "VisualComp 2.25.vst3"
   folder into C:\Program Files\Common Files\VST3\ yourself,
   and run "VisualComp 2.25.exe" from anywhere.
...
----------------------------------------------------------------
   1. Route the key track (e.g. the kick) to the track that
      hosts VisualComp 2.25, using the send arrow at the bottom
