...
----------------------------------------------------------------
   ...
   VisualComp 2.41 - User Manual.pdf   Complete illustrated manual
...
----------------------------------------------------------------
   ...
   2. Double-click  "Install VisualComp 2.41.bat"
   ...
   5. The plugin appears as "VisualComp 2.41" by Azazel Audio.

   To remove it later, run "Uninstall VisualComp 2.41.bat".
   Your presets are never touched by the uninstaller.

   Prefer to install by hand? Copy the "VisualComp 2.41.vst3"
   folder into C:\Program Files\Common Files\VST3\ yourself,
   and run "VisualComp 2.41.exe" from anywhere.
...
----------------------------------------------------------------
   ...
   Not code-signed. If your DAW refuses to load it:
     xattr -dr com.apple.quarantine ~/Library/Audio/Plug-Ins/VST3/"VisualComp 2.41.vst3"
...
----------------------------------------------------------------
   1. Route the key track (e.g. the kick) to the track that
      hosts VisualComp 2.41, using the send arrow at the bottom
