---
name: testbuild
description: Build just the VisualComp 2.27 Standalone target, drop it into "Build Final\Standalone Test", and launch it for a fast test loop. Use when asked to "test build", "quick build", "build and run", or "/testbuild".
---
