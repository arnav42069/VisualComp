VisualComp 2.26 — macOS Build Guide
Azazel Audio
===============================
...
in one pass and installed into their standard plugin folders automatically:
  ~/Library/Audio/Plug-Ins/VST3/VisualComp 2.26.vst3
  ~/Library/Audio/Plug-Ins/Components/VisualComp 2.26.component
...
- Gatekeeper: these plugins are not code-signed. If the DAW refuses to
  load one, run:
     ...
     xattr -dr com.apple.quarantine ~/Library/Audio/Plug-Ins/Components/"VisualComp 2.26.component"
